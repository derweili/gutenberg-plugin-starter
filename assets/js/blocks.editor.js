...
var _slider = _interopRequireDefault(__webpack_require__(48));
...
var _innerSlider = __webpack_require__(50);

var _json2mq = _interopRequireDefault(__webpack_require__(57));

var _defaultProps = _interopRequireDefault(__webpack_require__(59));
...
var enquire = (0, _innerSliderUtils.canUseDOM)() && __webpack_require__(60);
...
var _initialState = _interopRequireDefault(__webpack_require__(51));

var _lodash = _interopRequireDefault(__webpack_require__(52));

var _classnames = _interopRequireDefault(__webpack_require__(4));

var _innerSliderUtils = __webpack_require__(10);

var _track = __webpack_require__(53);

var _dots = __webpack_require__(54);

var _arrows = __webpack_require__(55);
...
var camel2hyphen = __webpack_require__(58);
...
var MediaQueryDispatch = __webpack_require__(61);
...
var MediaQuery = __webpack_require__(62);
...
var QueryHandler = __webpack_require__(63);
var each = __webpack_require__(44).each;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__antares_section__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__antares_list__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__antares_slider__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gated_asset__ = __webpack_require__(93);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editor_scss__ = __webpack_require__(69);
...
var colors = [{ name: 'black', color: '#000' }, { name: 'blue', color: '#0058A7' }, { name: 'light-blue', color: '#DBEFFB' }, { name: 'gray', color: '#E8E8E8' }];
...
registerBlockType('antares/section', {
    ...
    edit: function edit(props) {
        ...
        if (focalPoint) {
            backgroundImageStyle.objectPosition = focalPoint.x * 100 + '% ' + focalPoint.y * 100 + '%';
        }
        ...
        return wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    PanelBody,
                    { title: 'Hintergrund', initialOpen: true },
                    wp.element.createElement(
                        PanelRow,
                        null,
            ...
            wp.element.createElement(
                'div',
                { className: 'antares-section ' + (color ? 'color-' + getClassNameByColor(color) : '') },
                wp.element.createElement(
                    'div',
                    { className: 'antares-section--inner' },
                    wp.element.createElement(InnerBlocks, null)
                ),
                image && wp.element.createElement('img', { src: image.url, alt: image.alt, className: 'background-image', style: backgroundImageStyle }),
                image && wp.element.createElement('div', { className: 'backdrop', style: { opacity: dimRatio + '%' } })
            )
        );
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__style_scss__ = __webpack_require__(89);
...
registerBlockType('antares/list', {
    ...
    attributes: {
        listItems: {
            type: "array",
            default: [__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, emptyListItem)]
        }
    },
    supports: {
        align: ['wide']
    ...
    edit: function edit(props) {
        ...
        var updateListItem = function updateListItem(data, index) {
            var newItem = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, listItems[index], data);

            var newItems = [].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(listItems));
        ...
        var addNewItem = function addNewItem() {
            var newItems = [].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(listItems), [__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, emptyListItem)]);
    ...
    save: function save(props) {
        var listItems = props.attributes.listItems;
            ...
            listItems.map(function (listItem, index) {
                return wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        listItem.description && wp.element.createElement(RichText.Content, {
                            tagName: 'p' // The tag here is the element output and editable in the admin
                            , value: listItem.description // Any existing content, either from the database or an attribute default
                        })
                    )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__style_scss__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__editor_scss__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_slick__ = __webpack_require__(47);
...
registerBlockType('antares/slider', {
    ...
    attributes: {
        slides: {
            type: "array",
            default: [__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()({}, emtpySlide)]
        }
    },
    supports: {
        align: ['wide']
    ...
    edit: function edit(props) {
        ...
        var updateSlideItem = function updateSlideItem(data, index) {
            var newSlide = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()({}, slides[index], data);

            var newSlides = [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(slides));
        ...
        var addNewItem = function addNewItem() {
            var newItems = [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(slides), [__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()({}, emtpySlide)]);
        ...
        return wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        wp.element.createElement(
                            ...
                            slides.map(function (slide, index) {
                                var label = slide.description ? slide.description.substring(0, 10) : 'Slide ' + (index + 1);
            ...
            wp.element.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({ className: 'antares-slider' }, sliderSettings),
                slides.map(function (slide, index) {
                    return wp.element.createElement(
                        'div',
                        { className: 'slide', key: slide.index },
                        slide.image ? wp.element.createElement(MediaUpload, {
                            allowedTypes: ["image/jpg", "image/jpeg", "image/png"],
                            value: slide.image ? slide.image.id : null,
                            onSelect: function onSelect(image) {
                                return updateSlideItem({ image: image }, index);
                            },
                            render: function render(_ref) {
                                var open = _ref.open;
                                return wp.element.createElement('img', { src: slide.image.sizes.large ? slide.image.sizes.large.url : slide.image.url, alt: slide.image.alt, onClick: open });
                            }
                        }) : wp.element.createElement(MediaPlaceholder, {
                            onSelect: function onSelect(image) {
                                updateSlideItem({ image: image }, index);
                            },
                            allowedTypes: ['image'],
                            multiple: false,
                        ...
                        wp.element.createElement(
                            ...
                            wp.element.createElement(RichText, {
                                ...
                                , onChange: function onChange(title) {
                                    return updateSlideItem({ title: title }, index);
                                } // Store updated content as a block attribute
                                , placeholder: 'Beschreibung...' // Display this text before any content has been added by the user
                            })
                        )
    ...
    save: function save(props) {
        ...
        return wp.element.createElement(
            'div',
            { className: 'antares-slider ' },
            slides.map(function (slide, index) {
                return wp.element.createElement(
                    'div',
                    { className: 'slide' },
                    slide.image && wp.element.createElement('img', { src: slide.image.url, alt: slide.image.alt, className: 'wp-image-' + slide.image.id }),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editor_scss__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__editor_scss__);
...
registerBlockType('antares/gatedasset', {
    ...
    edit: function edit(props) {
        ...
        return wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                wp.element.createElement(
                    'a',
                    { 'class': 'download-link gated_asset_download' },
                    'Download PDF'
                )
            )
        );
    ...
    save: function save(props) {
        ...
        return wp.element.createElement(
            'div',
            { className: 'antares-gated-asset ' },
            label && wp.element.createElement(RichText.Content, {
                tagName: 'span' // The tag here is the element output and editable in the admin
                , value: label // Any existing content, either from the database or an attribute default
                , className: 'gated-asset-label'
            }),
            ...
            wp.element.createElement(
                'a',
                { 'class': 'download-link gated_asset_download', 'data-href': file ? file.url : '', download: true },
                'Download PDF'
            )
        );
    }

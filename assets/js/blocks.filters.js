...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__registerBlockType__ = __webpack_require__(99);
// Filters entry point
...
addFilter("blocks.registerBlockType", "jsforwp-advgb/extending-register-block-type", extendWithRegisterBlockType);
...
function extendWithRegisterBlockType(settings, name) {
  ...
  if ("core/code" === name) {
    ...
    settings.description = __("Use for maximum codiness 💃", "antaresplugin");
    ...
    // Change supports
    settings.supports = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({}, settings.supports, {
      html: true,
      anchor: true
    });

...
function block_filters(){
	...
	wp_enqueue_script( 
		"antares-plugin-filters-js",
		_get_plugin_url() . $filters_js_path,
		['wp-hooks', 'lodash', 'antares-plugin-editor-js'],
